    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
            ...
            <ul class="participants-list">
              ${participants.length
                ? participants
                    .map(
                      (p) =>
                        `<li><span class="participant-email">${p}</span><button type="button" class="remove-participant" data-activity="${encodeURIComponent(
                          name
        ...
        activityCard.addEventListener("click", async (event) => {
          ...
          const participantEmail = decodeURIComponent(event.target.dataset.participant);
